...
return [
    ...
    */
    ...
    // D-06: matches project cache/queue driver (database). Pitfall 1 — prune at 24h (below).
    ...
    */
    ...
    // D-06 Pitfall 1: cap telescope_entries growth. Daily telescope:prune scheduled in routes/console.php.
    'prune' => ['hours' => env('TELESCOPE_PRUNE_HOURS', 24)],
